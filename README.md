...
To optimize the fbpost application for production, run:
...
[Doing microservices with JHipster]: https://jhipster.github.io/documentation-archive/v4.0.5/microservices-architecture/
